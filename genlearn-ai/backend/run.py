#!/usr/bin/env python3
"""
GenLearn AI - Development Server Runner
...
def main():
    """Main entry point"""
    parser = argparse.ArgumentParser(description="Run GenLearn AI Backend Server")
    parser.add_argument(
        "--host",
        default="0.0.0.0",
    ...
    # Start server
    print("\n" + "=" * 60)
    print("🚀 Starting GenLearn AI Backend Server")
    print("=" * 60)
